...
//import './estilos.css'
import {Container, FormControl, InputLabel, Input, FormHelperText, Button, Grid, Paper, Typography} from '@material-ui/core';
...
export default function Registro_OPERADOR() {
    ...
    return (
        ...
        <Container maxWidth={false} align = 'center'>
            ...
            <Typography> Registro de Operadores Aquaspot</Typography>
            ...
            <Grid item xs={6}>
                <FormControl>
                    <InputLabel htmlFor = "tlf"> Cédula</InputLabel>
                    <Input id = "tlf" type = "teléfono" aria-describedby="teléfono-helper"/>
                    <FormHelperText id="teléfono-helper"> Ingrese su número de cédula </FormHelperText>
                </FormControl>
            </Grid>
            <Grid item xs={6}>
                <FormControl>
